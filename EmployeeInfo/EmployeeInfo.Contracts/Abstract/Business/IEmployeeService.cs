...
namespace EmployeeInfo.Contracts.Abstract
{
    public interface IEmployeeService
    {
        ...
        Task<EmployeeSearchResult> GetEmployeesAsync(string employeeName, string mobile, string aadhar, string uan, DateTime? dateFrom, DateTime? dateTo, 
            PaginationRequest paging, int totalCount, int newPageIndex);
